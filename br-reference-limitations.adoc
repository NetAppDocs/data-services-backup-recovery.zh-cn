...
** 如果您在 SnapMirror 目标卷上创建 Snapshot 的本地副本（无论使用何种 SnapMirror 标签），这些 Snapshot 都不会作为备份移动到云中。您必须在源 DP 卷上创建具有所需标签的 Snapshot 策略，以便 NetApp Backup and Recovery 可以对其进行备份。
