...
---
= NetApp Backup and Recovery 中的保护旅程规划选项
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
除了此标准之外，如果您使用 *Datalock and Ransomware protection* 功能，云存储还提供额外的安全选项，并通过为较旧的备份文件选择存档存储类来节省额外的成本。link:prev-ontap-policy-object-options.html["了解有关 DataLock 和勒索软件保护以及档案存储设置的更多信息"].
