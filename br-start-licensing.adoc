...
* 如果您使用的是带有 NetApp Console 的 Backup and Recovery，则可以订阅按需付费 (PAYGO) 许可证或购买自带许可证 (BYOL) 许可证。
...
设置 NetApp Backup and Recovery 的许可。
...
=== 使用带有 Marketplace 或 BYOL 许可证的年度合同
...
== 设置 NetApp Backup and Recovery 本地部署的许可

为 NetApp Console 的本地版本设置许可。
...
您可以使用 NetApp Console 本地部署来管理 BYOL 许可证。您可以从 Console 添加新许可证、更新现有许可证和查看许可证状态。
