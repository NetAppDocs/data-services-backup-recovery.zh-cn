...
summary: 在使用NetApp Backup and Recovery 之前，请执行几个步骤来设置备份目标。 
---
...
在备份目标本身中配置选项后，您稍后会将其配置为NetApp Backup and Recovery 中的备份目标。有关如何在NetApp Backup and Recovery 中配置备份目标的详细信息，请参阅link:br-start-discover-backup-targets.html["发现备份目标"]。
