...
要开始使用，您需要注册或联系您的NetApp销售代表来试用此服务。然后，当您使用控制台代理时，它将包含适合该服务的功能。
...
*如果您使用NetApp Backup and Recovery 设置策略，那么将来是否只需在此服务中进行更改？*我们建议您从NetApp Backup and Recovery 进行策略更改。
