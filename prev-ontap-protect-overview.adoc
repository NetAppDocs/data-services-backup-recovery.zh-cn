...
---
= 了解适用于 ONTAP 卷的 NetApp Backup and Recovery
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: 对"本地 ONTAP 系统"的引用包括 FAS、AFF 和 ONTAP Select 系统。
...
如果您的群集使用的是 ONTAP 9.11.1 或更高版本，您可以保护对象存储中的备份免受删除和勒索软件攻击。每个备份策略都提供了_数据锁和勒索软件保护_部分，可在特定时间段（_保留期_）内应用于您的备份文件。
