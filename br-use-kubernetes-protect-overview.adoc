...
---
= 了解如何通过 NetApp Backup and Recovery 管理 Kubernetes 工作负载
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
在 NetApp Backup and Recovery 中管理 Kubernetes 工作负载使您能够在一个地方发现、管理和保护您的 Kubernetes 集群和应用程序。您可以管理托管在 Kubernetes 集群上的资源和应用程序。您还可以使用单一界面创建保护策略并将其与 Kubernetes 应用程序关联。
