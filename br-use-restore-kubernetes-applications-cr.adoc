...
---
= 使用自定义资源通过 NetApp Backup and Recovery 还原 Kubernetes 应用程序
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* 您可以使用高级设置自定义还原操作。要了解更多信息，请参阅 link:br-use-kubernetes-advanced-restore-settings.html["NetApp Backup and Recovery 中 Kubernetes 的高级还原设置"]。
