...
---
= 在 NetApp Backup and Recovery 中管理备份到对象存储的选项
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.步骤
. 从*Volumes*选项卡中，选择*Backup Settings*。
. 在“备份设置”页面中，单击 image:icon-actions-horizontal.gif["更多图标"] 在系统中，选择“配置高级设置 > 系统设置”。
...
有关 Datalock 和勒索软件防护选项的详细信息，请参阅 link:prev-ontap-policy-object-options.html["Datalock 和勒索软件防护选项"]。
...
.步骤
. 从*Volumes*选项卡中，选择*Backup Settings*。
. 在“备份设置”页面中，单击 image:icon-actions-horizontal.gif["更多图标"] 在系统中，选择“配置高级设置 > 提供商设置”。
