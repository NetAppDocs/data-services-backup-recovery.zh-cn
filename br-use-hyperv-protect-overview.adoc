...
---
= 使用 NetApp Backup and Recovery 的 Hyper-V 保护工作流
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
使用NetApp Backup and Recovery保护您的 Hyper-V 虚拟机。NetApp Backup and Recovery为独立实例和 FCI 集群实例提供快速、节省空间、崩溃一致性和 VM 一致性的备份和恢复操作。您还可以保护由 System Center Virtual Machine Manager (SCVMM) 配置并托管在 CIFS 共享上的 Hyper-V 虚拟机。
