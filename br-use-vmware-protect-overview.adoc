...
---
= 使用 NetApp Backup and Recovery 的 VMware 保护工作流
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
使用 NetApp Backup and Recovery 保护您的 VMware 虚拟机和数据存储库。NetApp Backup and Recovery 提供快速、节省空间、崩溃一致性和 VM 一致性的备份和还原操作。您可以将 VMware 工作负载备份到支持的备份目标，并将 VMware 工作负载还原到本地 VMware 主机。
