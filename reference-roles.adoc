...
[role="lead"]
使用身份和访问管理 (IAM) 来控制每个用户可以访问的 NetApp Backup and Recovery 功能和操作。

要了解特定于 NetApp Backup and Recovery 的 IAM 角色，请参见 https://docs.netapp.com/us-en/console-setup-admin/reference-iam-backup-rec-roles.html["NetApp Console中的NetApp Backup and Recovery角色"^]。
