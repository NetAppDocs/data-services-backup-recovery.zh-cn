...
[role="lead"]
在 NetApp Backup and Recovery 中，可以将卷数据从主本地 ONTAP 系统备份到 ONTAP S3，也可以选择备份到辅助 ONTAP 系统进行复制。使用此页面可准备您的环境并激活备份。
...
. *复制*：如果选择了*复制*，请设置以下选项：
+
** *复制目标*：选择目标系统和存储虚拟机。可选择目标聚合（或 FlexGroup 卷的聚合）以及将添加到复制卷名称的前缀或后缀。
