...
summary: 在 NetApp Backup and Recovery 中为 Oracle Database 工作负载创建和管理保护组。 
---
...
[role="lead"]
创建保护组以管理 Oracle 数据库资源的备份操作。保护组是希望共同保护的资源（如数据库）的逻辑分组。

您可以执行与保护组相关的以下任务：

* 创建保护组。
* 查看保护详情。
* 立即备份保护组。请参阅link:br-use-oracle-backup.html["立即备份 Oracle Database 工作负载"]。
* 删除保护组。
