...
* *还原文件和文件夹时支持代理虚拟机* - 您现在可以将文件和文件夹还原到源 vCenter 上托管的其他虚拟机。有关详细信息，请参阅 https://docs.netapp.com/us-en/data-services-backup-recovery/br-use-vmware-restore.html["恢复 VMware 工作负载"]。
* *递归文件和文件夹搜索* - 您现在可以在整个 VMDK 中搜索特定文件或文件夹。有关详细信息，请参阅 https://docs.netapp.com/us-en/data-services-backup-recovery/br-use-vmware-restore.html["恢复 VMware 工作负载"]。
* *改进的作业处理*：NetApp Backup and Recovery 现在可以更有效地同时处理多个作业。
